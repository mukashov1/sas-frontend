...
import { BsFillXCircleFill, BsCheckCircleFill, BsHandIndexThumbFill, BsFillFileEarmarkPdfFill,BsArrowLeft } from 'react-icons/bs'
...
export default function Statistics({ handleBack }) {
    ...
    return (
        <div className={`statistics${showDropdown ? " statistics-scrollable" : ""}`} style={{ marginTop: '0px' }}>
            <h2 onClick={handleBack} style={{display: 'flex', alignItems: 'center',gap: '10px'}}><BsArrowLeft/>     Statistics</h2>
            <table>
                <thead>
                    <tr>
                        <th>SUBJECT</th>
